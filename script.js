...
const ButtonSetFunctions = React.createClass({ displayName: "ButtonSetFunctions",
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(Button, { text: "recall", clickHandler: this._showMemoryBank }), /*#__PURE__*/
      React.createElement(Button, { text: "clear", clickHandler: this._clear }), /*#__PURE__*/
